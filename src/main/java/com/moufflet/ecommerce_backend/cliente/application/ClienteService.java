...
public class ClienteService {
  ...
  public Cliente save(String id, Cliente cliente) {
    Cliente clienteOld = clienteRepositoryPort.findById(id)
        .orElseThrow(() -> new RuntimeException("Cliente no encontrado"));

    BeanUtils.copyProperties(cliente, clienteOld, getNullPropertyNames(cliente));

    return clienteRepositoryPort.save(clienteOld);
  }
  ...
  public String[] getNullPropertyNames(Cliente source) {
